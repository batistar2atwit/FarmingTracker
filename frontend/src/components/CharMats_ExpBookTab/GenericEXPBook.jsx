...
const GenericEXPBook = () => {
	...
	const totalExpBook1 =
		parseInt(levelUp02) * expInput02_1 +
		parseInt(levelUp24) * expInput24_1 +
		parseInt(levelUp45) * expInput45_1 +
		parseInt(levelUp56) * expInput56_1 +
		parseInt(levelUp67) * expInput67_1 +
		parseInt(levelUp78) * expInput78_1 +
		parseInt(levelUp89) * expInput89_1;

	const totalExpBook2 =
		parseInt(levelUp02) * expInput02_2 +
		parseInt(levelUp24) * expInput24_2 +
		parseInt(levelUp45) * expInput45_2 +
		parseInt(levelUp56) * expInput56_2 +
		parseInt(levelUp67) * expInput67_2 +
		parseInt(levelUp78) * expInput78_2 +
		parseInt(levelUp89) * expInput89_2;

	const totalExpBook3 =
		parseInt(levelUp02) * expInput02_3 +
		parseInt(levelUp24) * expInput24_3 +
		parseInt(levelUp45) * expInput45_3 +
		parseInt(levelUp56) * expInput56_3 +
		parseInt(levelUp67) * expInput67_3 +
		parseInt(levelUp78) * expInput78_3 +
		parseInt(levelUp89) * expInput89_3;

	//Total Exp needed to level up
	const expNeeded =
		parseInt(levelUp02) * expNeeded02 +
		parseInt(levelUp24) * expNeeded24 +
		parseInt(levelUp45) * expNeeded45 +
		parseInt(levelUp56) * expNeeded56 +
		parseInt(levelUp67) * expNeeded67 +
		parseInt(levelUp78) * expNeeded78 +
		parseInt(levelUp89) * expNeeded89;

	//Total Exp wasted when leveling up
	const expWasted =
		parseInt(levelUp02) * expWasted02 +
		parseInt(levelUp24) * expWasted24 +
		parseInt(levelUp45) * expWasted45 +
		parseInt(levelUp56) * expWasted56 +
		parseInt(levelUp67) * expWasted67 +
		parseInt(levelUp78) * expWasted78 +
		parseInt(levelUp89) * expWasted89;

	//Total mora cost
	const totalMoraCost =
		parseInt(levelUp02) * moraCost02 +
		parseInt(levelUp24) * moraCost24 +
		parseInt(levelUp45) * moraCost45 +
		parseInt(levelUp56) * moraCost56 +
		parseInt(levelUp67) * moraCost67 +
		parseInt(levelUp78) * moraCost78 +
		parseInt(levelUp89) * moraCost89;
