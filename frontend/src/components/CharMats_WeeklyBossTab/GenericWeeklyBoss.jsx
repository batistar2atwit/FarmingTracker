			...
			<div className="weekly-boss-block">
				<table className="weekly-boss-table">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<input
									...
									value={dvalinPlume - counterDvalin1}
									onChange={(e) => setDvalinPlume(e.target.value)}
									placeholder="0"
									min="0"
								/>
							</td>
						...
						<tr>
							...
							<td>
								<input
									type="number"
									className="weekly-boss-num-input"
									value={dvalinClaw - counterDvalin2}
									onChange={(e) => setDvalinClaw(e.target.value)}
									placeholder="0"
									min="0"
								/>
							</td>
						...
						<tr>
							<td>Dvalin's Sigh</td>
							<td>{4 * totalTalentLvUpPerChar - dvalinSigh}</td>
							<td>
								<input
									type="number"
									className="weekly-boss-num-input"
									value={dvalinSigh - counterDvalin3}
									onChange={(e) => setDvalinSigh(e.target.value)}
									placeholder="0"
									min="0"
								/>
							</td>
							...
							<td>Traveler(Anemo), Amber, Beidou, Chongyun</td>
						</tr>
						<tr>
							<td>TOTAL </td>
						...
						<tr>
							...
							<td>{4 * totalTalentLvUpPerChar - tailOfBoreas}</td>
							<td>
								<input
									type="number"
									className="weekly-boss-num-input"
							...
							<td>Traveler(Geo), Qiqi, Venti, Xingqiu</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>Dehya, Faruzan, nahida</td>
						</tr>
						<tr>
							<td>Mirror Of Mushin</td>
							<td>{2 * totalTalentLvUpPerChar - mirrorOfMushin}</td>
							<td>
								<input
									type="number"
									className="weekly-boss-num-input"
							...
							<td>Alhaitham, Layla</td>
						</tr>
						<tr>
							<td>Daka's Bell</td>
							<td>{2 * totalTalentLvUpPerChar - dakasBell}</td>
							<td>
								<input
									type="number"
									className="weekly-boss-num-input"
						...
						<tr className="weekly-total-row">
							<td>TOTAL</td>
							<td>
								{totalTalentLvUpPerChar * 70 -
									LvUpMatTotalHave(dvalinPlume, dvalinClaw, dvalinSigh) +
									LvUpMatTotalHave(tailOfBoreas, ringOfBoreas, spiritLocketOfBoreas) +
									LvUpMatTotalHave(tuskOfMonocerosCaeli, shardOfAFoulLegacy, shadowOfTheWarrior) +
									LvUpMatTotalHave(dragonLordCrown, bloodjadeBranch, gildedScale) +
									LvUpMatTotalHave(moltenMoment, hellfireButterfly, ashenHeart) +
									LvUpMatTotalHave(mudraOfTheMaleficGeneral, tearsOfTheCalamitousGod, theMeaningOfAeons) +
									LvUpMatTotalHave(puppetStrings, mirrorOfMushin, dakasBell)}
							</td>
							<td>
								{LvUpMatTotalHave(dvalinPlume, dvalinClaw, dvalinSigh) +
									LvUpMatTotalHave(tailOfBoreas, ringOfBoreas, spiritLocketOfBoreas) +
									...
									LvUpMatTotalHave(mudraOfTheMaleficGeneral, tearsOfTheCalamitousGod, theMeaningOfAeons) +
									LvUpMatTotalHave(puppetStrings, mirrorOfMushin, dakasBell) -
									LvUpMatTotalUsed(counterDvalin1, counterDvalin2, counterDvalin3) +
									LvUpMatTotalUsed(counterAndrius1, counterAndrius2, counterAndrius3) +
									LvUpMatTotalUsed(counterChilde1, counterChilde2, counterChilde3) +
									LvUpMatTotalUsed(counterAzhdaha1, counterAzhdaha2, counterAzhdaha3) +
									LvUpMatTotalUsed(counterSignora1, counterSignora2, counterSignora3) +
									LvUpMatTotalUsed(counterShogun1, counterShogun2, counterShogun3) +
									LvUpMatTotalUsed(counterJoururiWorkshop1, counterJoururiWorkshop2, counterJoururiWorkshop3)}
							</td>
							<td>
								{LvUpMatTotalUsed(counterDvalin1, counterDvalin2, counterDvalin3) +
									LvUpMatTotalUsed(counterAndrius1, counterAndrius2, counterAndrius3) +
