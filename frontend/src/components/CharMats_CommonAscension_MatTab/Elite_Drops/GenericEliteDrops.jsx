...
const GenericEliteDrops = () => {
	...
	return (
		<div>
			<h1 className="common-asc-mat-h1">Common Ascension Materials</h1>
			<div className="common-asc-mat-block">
				<table className="common-asc-mat-table">
					<thead className="common-asc-mat-header">
						<tr>
							<th>Common Ascension Materials</th>
							<th>Need</th>
							<th>Have</th>
							<th>Used</th>
							<th></th>
					...
					<tbody>
						<tr>
							...
							<td>
								<input type="number" className="common-asc-mat-num-input" value={dvalinPlume - counterDvalin1} onChange={(e) => setDvalinPlume(e.target.value)} placeholder="0" min="0" />
							</td>
							<td>
								{
									<>
										<button className="common-asc-mat-arrow-down" onClick={decrementCounterDvalin1}>
											-
										</button>

										<span className="common-asc-mat-arrow-mid-number">{parseInt(counterDvalin1)}</span>
										<button className="common-asc-mat-arrow-up" onClick={incrementCounterDvalin1}>
											+
										</button>
									</>
								}
						...
						<tr>
							...
							<td>
								<input type="number" className="common-asc-mat-num-input" value={dvalinClaw - counterDvalin2} onChange={(e) => setDvalinClaw(e.target.value)} placeholder="0" min="0" />
							</td>
							<td>
								{
									<>
										<button className="common-asc-mat-arrow-down" onClick={decrementCounterDvalin2}>
											-
										</button>
										<span className="common-asc-mat-arrow-mid-number">{parseInt(counterDvalin2)}</span>
										<button className="common-asc-mat-arrow-up" onClick={incrementCounterDvalin2}>
											+
										</button>
									</>
								}
						...
						<tr>
							...
							<td>
								<input type="number" className="common-asc-mat-num-input" value={dvalinSigh - counterDvalin3} onChange={(e) => setDvalinSigh(e.target.value)} placeholder="0" min="0" />
							</td>
							<td>
								{
									<>
										<button className="common-asc-mat-arrow-down" onClick={decrementCounterDvalin3}>
											-
										</button>
										<span className="common-asc-mat-arrow-mid-number">{parseInt(counterDvalin3)}</span>
										<button className="common-asc-mat-arrow-up" onClick={incrementCounterDvalin3}>
											+
										</button>
									</>
								}
						...
						<tr>
							...
							<td>
								<input type="number" className="common-asc-mat-num-input" value={tailOfBoreas - counterAndrius1} onChange={(e) => setTailOfBoreas(e.target.value)} placeholder="0" min="0" />
							</td>
							<td>
								{
									<>
										<button className="common-asc-mat-arrow-down" onClick={decrementCounterAndrius1}>
											-
										</button>
										<span className="common-asc-mat-arrow-mid-number">{parseInt(counterAndrius1)}</span>
										<button className="common-asc-mat-arrow-up" onClick={incrementCounterAndrius1}>
											+
										</button>
									</>
								}
						...
						<tr>
							...
							<td>
								<input type="number" className="common-asc-mat-num-input" value={ringOfBoreas - counterAndrius2} onChange={(e) => setRingOfBoreas(e.target.value)} placeholder="0" min="0" />
							</td>
							<td>
								{
									<>
										<button className="common-asc-mat-arrow-down" onClick={decrementCounterAndrius2}>
											-
										</button>
										<span className="common-asc-mat-arrow-mid-number">{parseInt(counterAndrius2)}</span>
										<button className="common-asc-mat-arrow-up" onClick={incrementCounterAndrius2}>
											+
										</button>
									</>
								}
						...
						<tr>
							...
							<td>
								<input
									type="number"
									className="common-asc-mat-num-input"
							...
							<td>
								{
									<>
										<button className="common-asc-mat-arrow-down" onClick={decrementCounterAndrius3}>
											-
										</button>
										<span className="common-asc-mat-arrow-mid-number">{parseInt(counterAndrius3)}</span>
										<button className="common-asc-mat-arrow-up" onClick={incrementCounterAndrius3}>
											+
										</button>
									</>
								}
						...
						<tr>
							...
							<td>
								{
									<>
										<button className="common-asc-mat-arrow-down" onClick={decrementCounterChilde1}>
											-
										</button>
										<span className="common-asc-mat-arrow-mid-number">{parseInt(counterChilde1)}</span>
										<button className="common-asc-mat-arrow-up" onClick={incrementCounterChilde1}>
											+
										</button>
									</>
								}
						...
						<tr>
							...
							<td>
								<input type="number" className="common-asc-mat-num-input" value={shardOfAFoulLegacy - counterChilde2} onChange={(e) => setShardOfAFoulLegacy(e.target.value)} placeholder="0" min="0" />
							</td>
							<td>
								{
									<>
										<button className="common-asc-mat-arrow-down" onClick={decrementCounterChilde2}>
											-
										</button>
										<span className="common-asc-mat-arrow-mid-number">{parseInt(counterChilde2)}</span>
										<button className="common-asc-mat-arrow-up" onClick={incrementCounterChilde2}>
											+
										</button>
									</>
								}
						...
						<tr>
							...
							<td>
								<input type="number" className="common-asc-mat-num-input" value={shadowOfTheWarrior - counterChilde3} onChange={(e) => setShadowOfTheWarrior(e.target.value)} placeholder="0" min="0" />
							</td>
							<td>
								{
									<>
										<button className="common-asc-mat-arrow-down" onClick={decrementCounterChilde3}>
											-
										</button>
										<span className="common-asc-mat-arrow-mid-number">{parseInt(counterChilde3)}</span>
										<button className="common-asc-mat-arrow-up" onClick={incrementCounterChilde3}>
											+
										</button>
									</>
								}
						...
						<tr>
							...
							<td>
								<input type="number" className="common-asc-mat-num-input" value={dragonLordCrown - counterAzhdaha1} onChange={(e) => setDragonLordCrown(e.target.value)} placeholder="0" min="0" />
							</td>
							<td>
								{
									<>
										<button className="common-asc-mat-arrow-down" onClick={decrementCounterAzhdaha1}>
											-
										</button>
										<span className="common-asc-mat-arrow-mid-number">{parseInt(counterAzhdaha1)}</span>
										<button className="common-asc-mat-arrow-up" onClick={incrementCounterAzhdaha1}>
											+
										</button>
									</>
								}
						...
						<tr>
							...
							<td>
								<input type="number" className="common-asc-mat-num-input" value={bloodjadeBranch - counterAzhdaha2} onChange={(e) => setBloodjadeBranch(e.target.value)} placeholder="0" min="0" />
							</td>
							<td>
								{
									<>
										<button className="common-asc-mat-arrow-down" onClick={decrementCounterAzhdaha2}>
											-
										</button>
										<span className="common-asc-mat-arrow-mid-number">{parseInt(counterAzhdaha2)}</span>
										<button className="common-asc-mat-arrow-up" onClick={incrementCounterAzhdaha2}>
											+
										</button>
									</>
								}
						...
						<tr>
							...
							<td>
								<input type="number" className="common-asc-mat-num-input" value={gildedScale - counterAzhdaha3} onChange={(e) => setGildedScale(e.target.value)} placeholder="0" min="0" />
							</td>
							<td>
								{
									<>
										<button className="common-asc-mat-arrow-down" onClick={decrementCounterAzhdaha3}>
											-
										</button>
										<span className="common-asc-mat-arrow-mid-number">{parseInt(counterAzhdaha3)}</span>
										<button className="common-asc-mat-arrow-up" onClick={incrementCounterAzhdaha3}>
											+
										</button>
									</>
								}
						...
						<tr className="common-asc-mat-total-row">
							<td>TOTAL</td>
						...
						<tr>
							...
							<td>
								<input type="number" className="common-asc-mat-num-input" value={moltenMoment - counterSignora1} onChange={(e) => setMoltenMoment(e.target.value)} placeholder="0" min="0" />
							</td>
							<td>
								{
									<>
										<button className="common-asc-mat-arrow-down" onClick={decrementCounterSignora1}>
											-
										</button>
										<span className="common-asc-mat-arrow-mid-number">{parseInt(counterSignora1)}</span>
										<button className="common-asc-mat-arrow-up" onClick={incrementCounterSignora1}>
											+
										</button>
									</>
								}
						...
						<tr>
							...
							<td>
								<input type="number" className="common-asc-mat-num-input" value={hellfireButterfly - counterSignora2} onChange={(e) => setHellfireButterfly(e.target.value)} placeholder="0" min="0" />
							</td>
							<td>
								{
									<>
										<button className="common-asc-mat-arrow-down" onClick={decrementCounterSignora2}>
											-
										</button>
										<span className="common-asc-mat-arrow-mid-number">{parseInt(counterSignora2)}</span>
										<button className="common-asc-mat-arrow-up" onClick={incrementCounterSignora2}>
											+
										</button>
									</>
								}
						...
						<tr>
							...
							<td>
								<input type="number" className="common-asc-mat-num-input" value={ashenHeart - counterSignora3} onChange={(e) => setAshenHeart(e.target.value)} placeholder="0" min="0" />
							</td>
							<td>
								{
									<>
										<button className="common-asc-mat-arrow-down" onClick={decrementCounterSignora3}>
											-
										</button>
										<span className="common-asc-mat-arrow-mid-number">{parseInt(counterSignora3)}</span>
										<button className="common-asc-mat-arrow-up" onClick={incrementCounterSignora3}>
											+
										</button>
									</>
								}
						...
						<tr>
							...
							<td>
								{
									<>
										<button className="common-asc-mat-arrow-down" onClick={decrementCounterShogun1}>
											-
										</button>
										<span className="common-asc-mat-arrow-mid-number">{parseInt(counterShogun1)}</span>
										<button className="common-asc-mat-arrow-up" onClick={incrementCounterShogun1}>
											+
										</button>
									</>
								}
						...
						<tr>
							...
							<td>
								{
									<>
										<button className="common-asc-mat-arrow-down" onClick={decrementCounterShogun2}>
											-
										</button>
										<span className="common-asc-mat-arrow-mid-number">{parseInt(counterShogun2)}</span>
										<button className="common-asc-mat-arrow-up" onClick={incrementCounterShogun2}>
											+
										</button>
									</>
								}
						...
						<tr>
							...
							<td>
								<input type="number" className="common-asc-mat-num-input" value={theMeaningOfAeons - counterShogun3} onChange={(e) => setTheMeaningOfAeons(e.target.value)} placeholder="0" min="0" />
							</td>
							<td>
								{
									<>
										<button className="common-asc-mat-arrow-down" onClick={decrementCounterShogun3}>
											-
										</button>
										<span className="common-asc-mat-arrow-mid-number">{parseInt(counterShogun3)}</span>
										<button className="common-asc-mat-arrow-up" onClick={incrementCounterShogun3}>
											+
										</button>
									</>
								}
						...
						<tr>
							...
							<td>
								<input type="number" className="common-asc-mat-num-input" value={puppetStrings - counterJoururiWorkshop1} onChange={(e) => setPuppetStrings(e.target.value)} placeholder="0" min="0" />
							</td>
							<td>
								{
									<>
										<button className="common-asc-mat-arrow-down" onClick={decrementCounterJoururiWorkshop1}>
											-
										</button>
										<span className="common-asc-mat-arrow-mid-number">{parseInt(counterJoururiWorkshop1)}</span>
										<button className="common-asc-mat-arrow-up" onClick={incrementCounterJoururiWorkshop1}>
											+
										</button>
									</>
								}
						...
						<tr>
							...
							<td>
								{
									<>
										<button className="common-asc-mat-arrow-down" onClick={decrementCounterJoururiWorkshop2}>
											-
										</button>
										<span className="common-asc-mat-arrow-mid-number">{parseInt(counterJoururiWorkshop2)}</span>
										<button className="common-asc-mat-arrow-up" onClick={incrementCounterJoururiWorkshop2}>
											+
										</button>
									</>
								}
						...
						<tr>
							...
							<td>
								<input type="number" className="common-asc-mat-num-input" value={dakasBell - counterJoururiWorkshop3} onChange={(e) => setDakasBell(e.target.value)} placeholder="0" min="0" />
							</td>
							<td>
								{
									<>
										<button className="common-asc-mat-arrow-down" onClick={decrementCounterJoururiWorkshop3}>
											-
										</button>
										<span className="common-asc-mat-arrow-mid-number">{parseInt(counterJoururiWorkshop3)}</span>
										<button className="common-asc-mat-arrow-up" onClick={incrementCounterJoururiWorkshop3}>
											+
										</button>
									</>
								}
...
export default GenericEliteDrops;
