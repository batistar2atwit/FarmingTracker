				...
				<table className="elite-asc-mat-table">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<input type="number" className="elite-asc-mat-num-input" value={freedom1 - counterFreedom11} onChange={(e) => setFreedom1(e.target.value)} placeholder="0" min="0" />
							</td>
							<td>
								{
									<>
										<button className="elite-asc-mat-arrow-down" onClick={decrementCounterFreedom11}>
											-
										</button>

										<span className="elite-asc-mat-arrow-mid-number">{parseInt(counterFreedom11)}</span>
										<button className="elite-asc-mat-arrow-up" onClick={incrementCounterFreedom11}>
											+
										</button>
									</>
								}
						...
						<tr>
							...
							<td>
								<input type="number" className="elite-asc-mat-num-input" value={freedom2 - counterFreedom3} onChange={(e) => setFreedom2(e.target.value)} placeholder="0" min="0" />
							</td>
							<td>
								{
									<>
										<button className="elite-asc-mat-arrow-down" onClick={decrementCounterFreedom3}>
											-
										</button>
										<span className="elite-asc-mat-arrow-mid-number">{parseInt(counterFreedom3)}</span>
										<button className="elite-asc-mat-arrow-up" onClick={incrementCounterFreedom3}>
											+
										</button>
									</>
								}
						...
						<tr>
							...
							<td>
								<input type="number" className="elite-asc-mat-num-input" value={freedom3 - counterFreedom2} onChange={(e) => setFreedom3(e.target.value)} placeholder="0" min="0" />
							</td>
							<td>
								{
									<>
										<button className="elite-asc-mat-arrow-down" onClick={decrementCounterFreedom2}>
											-
										</button>
										<span className="elite-asc-mat-arrow-mid-number">{parseInt(counterFreedom2)}</span>
										<button className="elite-asc-mat-arrow-up" onClick={incrementCounterFreedom2}>
											+
										</button>
									</>
								}
						...
						<tr className="elite-asc-mat-total-row">
							<td>TOTAL </td>
						...
						<tr>
							...
							<td>
								<input type="number" className="elite-asc-mat-num-input" value={resistance1 - counterResistance1} onChange={(e) => setResistance1(e.target.value)} placeholder="0" min="0" />
							</td>
							<td>
								{
									<>
										<button className="elite-asc-mat-arrow-down" onClick={decrementCounterResistance1}>
											-
										</button>
										<span className="elite-asc-mat-arrow-mid-number">{parseInt(counterResistance1)}</span>
										<button className="elite-asc-mat-arrow-up" onClick={incrementCounterResistance1}>
											+
										</button>
									</>
								}
						...
						<tr>
							...
							<td>
								<input type="number" className="elite-asc-mat-num-input" value={resistance2 - counterResistance2} onChange={(e) => setResistance2(e.target.value)} placeholder="0" min="0" />
							</td>
							<td>
								{
									<>
										<button className="elite-asc-mat-arrow-down" onClick={decrementCounterResistance2}>
											-
										</button>
										<span className="elite-asc-mat-arrow-mid-number">{parseInt(counterResistance2)}</span>
										<button className="elite-asc-mat-arrow-up" onClick={incrementCounterResistance2}>
											+
										</button>
									</>
								}
						...
						<tr>
							...
							<td>
								<input type="number" className="elite-asc-mat-num-input" value={resistance3 - counterResistance3} onChange={(e) => setResistance3(e.target.value)} placeholder="0" min="0" />
							</td>
							<td>
								{
									<>
										<button className="elite-asc-mat-arrow-down" onClick={decrementCounterResistance3}>
											-
										</button>
										<span className="elite-asc-mat-arrow-mid-number">{parseInt(counterResistance3)}</span>
										<button className="elite-asc-mat-arrow-up" onClick={incrementCounterResistance3}>
											+
										</button>
									</>
								}
						...
						<tr>
							...
							<td>
								<input type="number" className="elite-asc-mat-num-input" value={ballad1 - counterBallad1} onChange={(e) => setBallad1(e.target.value)} placeholder="0" min="0" />
							</td>
							<td>
								{
									<>
										<button className="elite-asc-mat-arrow-down" onClick={decrementCounterBallad1}>
											-
										</button>
										<span className="elite-asc-mat-arrow-mid-number">{parseInt(counterBallad1)}</span>
										<button className="elite-asc-mat-arrow-up" onClick={incrementCounterBallad1}>
											+
										</button>
									</>
								}
						...
						<tr>
							...
							<td>
								<input type="number" className="elite-asc-mat-num-input" value={ballad2 - counterBallad2} onChange={(e) => setBallad2(e.target.value)} placeholder="0" min="0" />
							</td>
							<td>
								{
									<>
										<button className="elite-asc-mat-arrow-down" onClick={decrementCounterBallad2}>
											-
										</button>
										<span className="elite-asc-mat-arrow-mid-number">{parseInt(counterBallad2)}</span>
										<button className="elite-asc-mat-arrow-up" onClick={incrementCounterBallad2}>
											+
										</button>
									</>
								}
						...
						<tr>
							...
							<td>
								<input type="number" className="elite-asc-mat-num-input" value={ballad3 - counterBallad3} onChange={(e) => setBallad3(e.target.value)} placeholder="0" min="0" />
							</td>
							<td>
								{
									<>
										<button className="elite-asc-mat-arrow-down" onClick={decrementCounterBallad3}>
											-
										</button>
										<span className="elite-asc-mat-arrow-mid-number">{parseInt(counterBallad3)}</span>
										<button className="elite-asc-mat-arrow-up" onClick={incrementCounterBallad3}>
											+
										</button>
									</>
								}
						...
						<tr>
							...
							<td>
								<input type="number" className="elite-asc-mat-num-input" value={prosperity1 - counterProsperity1} onChange={(e) => setProsperity1(e.target.value)} placeholder="0" min="0" />
							</td>
							<td>
								{
									<>
										<button className="elite-asc-mat-arrow-down" onClick={decrementCounterProsperity1}>
											-
										</button>
										<span className="elite-asc-mat-arrow-mid-number">{parseInt(counterProsperity1)}</span>
										<button className="elite-asc-mat-arrow-up" onClick={incrementCounterProsperity1}>
											+
										</button>
									</>
								}
						...
						<tr>
							...
							<td>
								<input type="number" className="elite-asc-mat-num-input" value={prosperity2 - counterProsperity2} onChange={(e) => setProsperity2(e.target.value)} placeholder="0" min="0" />
							</td>
							<td>
								{
									<>
										<button className="elite-asc-mat-arrow-down" onClick={decrementCounterProsperity2}>
											-
										</button>
										<span className="elite-asc-mat-arrow-mid-number">{parseInt(counterProsperity2)}</span>
										<button className="elite-asc-mat-arrow-up" onClick={incrementCounterProsperity2}>
											+
										</button>
									</>
								}
						...
						<tr>
							...
							<td>
								<input type="number" className="elite-asc-mat-num-input" value={prosperity3 - counterProsperity3} onChange={(e) => setProsperity3(e.target.value)} placeholder="0" min="0" />
							</td>
							<td>
								{
									<>
										<button className="elite-asc-mat-arrow-down" onClick={decrementCounterProsperity3}>
											-
										</button>
										<span className="elite-asc-mat-arrow-mid-number">{parseInt(counterProsperity3)}</span>
										<button className="elite-asc-mat-arrow-up" onClick={incrementCounterProsperity3}>
											+
										</button>
									</>
								}
						...
						<tr>
							...
							<td>
								<input type="number" className="elite-asc-mat-num-input" value={diligence1 - counterDiligence1} onChange={(e) => setDiligence1(e.target.value)} placeholder="0" min="0" />
							</td>
							<td>
								{
									<>
										<button className="elite-asc-mat-arrow-down" onClick={decrementCounterDiligence1}>
											-
										</button>
										<span className="elite-asc-mat-arrow-mid-number">{parseInt(counterDiligence1)}</span>
										<button className="elite-asc-mat-arrow-up" onClick={incrementCounterDiligence1}>
											+
										</button>
									</>
								}
						...
						<tr>
							...
							<td>
								<input type="number" className="elite-asc-mat-num-input" value={diligence2 - counterDiligence2} onChange={(e) => setDiligence2(e.target.value)} placeholder="0" min="0" />
							</td>
							<td>
								{
									<>
										<button className="elite-asc-mat-arrow-down" onClick={decrementCounterDiligence2}>
											-
										</button>
										<span className="elite-asc-mat-arrow-mid-number">{parseInt(counterDiligence2)}</span>
										<button className="elite-asc-mat-arrow-up" onClick={incrementCounterDiligence2}>
											+
										</button>
									</>
								}
						...
						<tr>
							...
							<td>
								<input type="number" className="elite-asc-mat-num-input" value={diligence3 - counterDiligence3} onChange={(e) => setDiligence3(e.target.value)} placeholder="0" min="0" />
							</td>
							<td>
								{
									<>
										<button className="elite-asc-mat-arrow-down" onClick={decrementCounterDiligence3}>
											-
										</button>
										<span className="elite-asc-mat-arrow-mid-number">{parseInt(counterDiligence3)}</span>
										<button className="elite-asc-mat-arrow-up" onClick={incrementCounterDiligence3}>
											+
										</button>
									</>
								}
						...
						<tr>
							...
							<td>
								<input type="number" className="elite-asc-mat-num-input" value={gold1 - counterGold1} onChange={(e) => setGold1(e.target.value)} placeholder="0" min="0" />
							</td>
							<td>
								{
									<>
										<button className="elite-asc-mat-arrow-down" onClick={decrementCounterGold1}>
											-
										</button>
										<span className="elite-asc-mat-arrow-mid-number">{parseInt(counterGold1)}</span>
										<button className="elite-asc-mat-arrow-up" onClick={incrementCounterGold1}>
											+
										</button>
									</>
								}
						...
						<tr>
							...
							<td>
								<input type="number" className="elite-asc-mat-num-input" value={gold2 - counterGold2} onChange={(e) => setGold2(e.target.value)} placeholder="0" min="0" />
							</td>
							<td>
								{
									<>
										<button className="elite-asc-mat-arrow-down" onClick={decrementCounterGold2}>
											-
										</button>
										<span className="elite-asc-mat-arrow-mid-number">{parseInt(counterGold2)}</span>
										<button className="elite-asc-mat-arrow-up" onClick={incrementCounterGold2}>
											+
										</button>
									</>
								}
						...
						<tr>
							...
							<td>
								<input type="number" className="elite-asc-mat-num-input" value={gold3 - counterGold3} onChange={(e) => setGold3(e.target.value)} placeholder="0" min="0" />
							</td>
							<td>
								{
									<>
										<button className="elite-asc-mat-arrow-down" onClick={decrementCounterGold3}>
											-
										</button>
										<span className="elite-asc-mat-arrow-mid-number">{parseInt(counterGold3)}</span>
										<button className="elite-asc-mat-arrow-up" onClick={incrementCounterGold3}>
											+
										</button>
									</>
								}
						...
						<tr>
							...
							<td>
								<input type="number" className="elite-asc-mat-num-input" value={transience1 - counterTransience1} onChange={(e) => setTransience1(e.target.value)} placeholder="0" min="0" />
							</td>
							<td>
								{
									<>
										<button className="elite-asc-mat-arrow-down" onClick={decrementCounterTransience1}>
											-
										</button>
										<span className="elite-asc-mat-arrow-mid-number">{parseInt(counterTransience1)}</span>
										<button className="elite-asc-mat-arrow-up" onClick={incrementCounterTransience1}>
											+
										</button>
									</>
								}
						...
						<tr>
							...
							<td>
								<input type="number" className="elite-asc-mat-num-input" value={transience2 - counterTransience2} onChange={(e) => setTransience2(e.target.value)} placeholder="0" min="0" />
							</td>
							<td>
								{
									<>
										<button className="elite-asc-mat-arrow-down" onClick={decrementCounterTransience2}>
											-
										</button>
										<span className="elite-asc-mat-arrow-mid-number">{parseInt(counterTransience2)}</span>
										<button className="elite-asc-mat-arrow-up" onClick={incrementCounterTransience2}>
											+
										</button>
									</>
								}
						...
						<tr>
							...
							<td>
								<input type="number" className="elite-asc-mat-num-input" value={transience3 - counterTransience3} onChange={(e) => setTransience3(e.target.value)} placeholder="0" min="0" />
							</td>
							<td>
								{
									<>
										<button className="elite-asc-mat-arrow-down" onClick={decrementCounterTransience3}>
											-
										</button>
										<span className="elite-asc-mat-arrow-mid-number">{parseInt(counterTransience3)}</span>
										<button className="elite-asc-mat-arrow-up" onClick={incrementCounterTransience3}>
											+
										</button>
									</>
								}
						...
						<tr>
							...
							<td>
								<input type="number" className="elite-asc-mat-num-input" value={elegance1 - counterElegance1} onChange={(e) => setElegance1(e.target.value)} placeholder="0" min="0" />
							</td>
							<td>
								{
									<>
										<button className="elite-asc-mat-arrow-down" onClick={decrementCounterElegance1}>
											-
										</button>
										<span className="elite-asc-mat-arrow-mid-number">{parseInt(counterElegance1)}</span>
										<button className="elite-asc-mat-arrow-up" onClick={incrementCounterElegance1}>
											+
										</button>
									</>
								}
						...
						<tr>
							...
							<td>
								<input type="number" className="elite-asc-mat-num-input" value={elegance2 - counterElegance2} onChange={(e) => setElegance2(e.target.value)} placeholder="0" min="0" />
							</td>
							<td>
								{
									<>
										<button className="elite-asc-mat-arrow-down" onClick={decrementCounterElegance2}>
											-
										</button>
										<span className="elite-asc-mat-arrow-mid-number">{parseInt(counterElegance2)}</span>
										<button className="elite-asc-mat-arrow-up" onClick={incrementCounterElegance2}>
											+
										</button>
									</>
								}
						...
						<tr>
							...
							<td>
								<input type="number" className="elite-asc-mat-num-input" value={elegance3 - counterElegance3} onChange={(e) => setElegance3(e.target.value)} placeholder="0" min="0" />
							</td>
							<td>
								{
									<>
										<button className="elite-asc-mat-arrow-down" onClick={decrementCounterElegance3}>
											-
										</button>
										<span className="elite-asc-mat-arrow-mid-number">{parseInt(counterElegance3)}</span>
										<button className="elite-asc-mat-arrow-up" onClick={incrementCounterElegance3}>
											+
										</button>
									</>
								}
						...
						<tr>
							...
							<td>
								<input type="number" className="elite-asc-mat-num-input" value={light1 - counterLight1} onChange={(e) => setLight1(e.target.value)} placeholder="0" min="0" />
							</td>
							<td>
								{
									<>
										<button className="elite-asc-mat-arrow-down" onClick={decrementCounterLight1}>
											-
										</button>
										<span className="elite-asc-mat-arrow-mid-number">{parseInt(counterLight1)}</span>
										<button className="elite-asc-mat-arrow-up" onClick={incrementCounterLight1}>
											+
										</button>
									</>
								}
						...
						<tr>
							...
							<td>
								<input type="number" className="elite-asc-mat-num-input" value={light2 - counterLight2} onChange={(e) => setLight2(e.target.value)} placeholder="0" min="0" />
							</td>
							<td>
								{
									<>
										<button className="elite-asc-mat-arrow-down" onClick={decrementCounterLight2}>
											-
										</button>
										<span className="elite-asc-mat-arrow-mid-number">{parseInt(counterLight2)}</span>
										<button className="elite-asc-mat-arrow-up" onClick={incrementCounterLight2}>
											+
										</button>
									</>
								}
						...
						<tr>
							...
							<td>
								<input type="number" className="elite-asc-mat-num-input" value={light3 - counterLight3} onChange={(e) => setLight3(e.target.value)} placeholder="0" min="0" />
							</td>
							<td>
								{
									<>
										<button className="elite-asc-mat-arrow-down" onClick={decrementCounterLight3}>
											-
										</button>
										<span className="elite-asc-mat-arrow-mid-number">{parseInt(counterLight3)}</span>
										<button className="elite-asc-mat-arrow-up" onClick={incrementCounterLight3}>
											+
										</button>
									</>
								}
						...
						<tr>
							...
							<td>
								<input type="number" className="elite-asc-mat-num-input" value={admonition1 - counterAdmonition1} onChange={(e) => setAdmonition1(e.target.value)} placeholder="0" min="0" />
							</td>
							<td>
								{
									<>
										<button className="elite-asc-mat-arrow-down" onClick={decrementCounterAdmonition1}>
											-
										</button>
										<span className="elite-asc-mat-arrow-mid-number">{parseInt(counterAdmonition1)}</span>
										<button className="elite-asc-mat-arrow-up" onClick={incrementCounterAdmonition1}>
											+
										</button>
									</>
								}
						...
						<tr>
							...
							<td>
								<input type="number" className="elite-asc-mat-num-input" value={admonition2 - counterAdmonition2} onChange={(e) => setAdmonition2(e.target.value)} placeholder="0" min="0" />
							</td>
							<td>
								{
									<>
										<button className="elite-asc-mat-arrow-down" onClick={decrementCounterAdmonition2}>
											-
										</button>
										<span className="elite-asc-mat-arrow-mid-number">{parseInt(counterAdmonition2)}</span>
										<button className="elite-asc-mat-arrow-up" onClick={incrementCounterAdmonition2}>
											+
										</button>
									</>
								}
						...
						<tr>
							...
							<td>
								<input type="number" className="elite-asc-mat-num-input" value={admonition3 - counterAdmonition3} onChange={(e) => setAdmonition3(e.target.value)} placeholder="0" min="0" />
							</td>
							<td>
								{
									<>
										<button className="elite-asc-mat-arrow-down" onClick={decrementCounterAdmonition3}>
											-
										</button>
										<span className="elite-asc-mat-arrow-mid-number">{parseInt(counterAdmonition3)}</span>
										<button className="elite-asc-mat-arrow-up" onClick={incrementCounterAdmonition3}>
											+
										</button>
									</>
								}
						...
						<tr>
							...
							<td>
								<input type="number" className="elite-asc-mat-num-input" value={ingenuity1 - counterIngenuity1} onChange={(e) => setIngenuity1(e.target.value)} placeholder="0" min="0" />
							</td>
							<td>
								{
									<>
										<button className="elite-asc-mat-arrow-down" onClick={decrementCounterIngenuity1}>
											-
										</button>
										<span className="elite-asc-mat-arrow-mid-number">{parseInt(counterIngenuity1)}</span>
										<button className="elite-asc-mat-arrow-up" onClick={incrementCounterIngenuity1}>
											+
										</button>
									</>
								}
						...
						<tr>
							...
							<td>
								<input type="number" className="elite-asc-mat-num-input" value={ingenuity2 - counterIngenuity2} onChange={(e) => setIngenuity2(e.target.value)} placeholder="0" min="0" />
							</td>
							<td>
								{
									<>
										<button className="elite-asc-mat-arrow-down" onClick={decrementCounterIngenuity2}>
											-
										</button>
										<span className="elite-asc-mat-arrow-mid-number">{parseInt(counterIngenuity2)}</span>
										<button className="elite-asc-mat-arrow-up" onClick={incrementCounterIngenuity2}>
											+
										</button>
									</>
								}
						...
						<tr>
							...
							<td>
								<input type="number" className="elite-asc-mat-num-input" value={ingenuity3 - counterIngenuity3} onChange={(e) => setIngenuity3(e.target.value)} placeholder="0" min="0" />
							</td>
							<td>
								{
									<>
										<button className="elite-asc-mat-arrow-down" onClick={decrementCounterIngenuity3}>
											-
										</button>
										<span className="elite-asc-mat-arrow-mid-number">{parseInt(counterIngenuity3)}</span>
										<button className="elite-asc-mat-arrow-up" onClick={incrementCounterIngenuity3}>
											+
										</button>
									</>
								}
